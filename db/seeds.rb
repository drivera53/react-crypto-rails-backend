...
portfolio1 = Portfolio.create(:name => "Doge Portfolio", :description => "Testing Doge", :initial_balance => 10000)
trade1 = Trade.create(:name => "Bitcoin", :trade_type => "buy", :coin_id => "btc", :price => 109, :quantity => 90, :portfolio_id => 1)
